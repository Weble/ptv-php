 ...
 *
 * Starts and creates the areas which can be reached from a waypoint or from a route, within given
 * horizons. This type of request is recommended when the **horizons** parameter is more than 20
 * minutes or 25 km.
 */
class StartAndCreateReachableAreas extends Request implements HasBody
{
	use HasJsonBody;
